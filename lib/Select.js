...
var actions = (_actions = {}, _defineProperty(_actions, KEY_CODES.UP_ARROW, 'handleUpArrow'), _defineProperty(_actions, KEY_CODES.DOWN_ARROW, 'handleDownArrow'), _defineProperty(_actions, KEY_CODES.ENTER, 'handleEnterPress'), _defineProperty(_actions, KEY_CODES.TAB, 'handleTabPress'), _defineProperty(_actions, KEY_CODES.BACKSPACE, 'handleBackspacePress'), _actions);
...
var Select = function (_Component) {
  ...
  _createClass(Select, [{
     ...
     * 5. has clear button
     */
    value: function handleBackspacePress() {
      if (this.state.focused && !this.state.isOpen && !this.state.searchTerm && !this.props.disabled && this.props.showClear) {
