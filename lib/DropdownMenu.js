  ...
  _createClass(DropdownMenu, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          otherProps = _objectWithoutProperties(_props2, ['className', 'select', 'handleKeyDown', 'highlightedOption', 'containerWidth', 'onRef', 'beforeOptionsComponent', 'afterOptionsComponent']);
